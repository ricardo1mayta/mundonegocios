...
@Component({
  standalone: true,
  selector: 'app-pedidos-general-grafico',
  imports: [BaseChartDirective],
  templateUrl: './pedidos-general-grafico.component.html',
  styleUrl: './pedidos-general-grafico.component.css',
})
export class PedidosGeneralGraficoComponent {
